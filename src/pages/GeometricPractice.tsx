                    ...
                    <div className="max-w-md mx-auto space-y-6">
                      ...
                      <AnimatePresence>
                        {feedback && (
                          ...
                          >
                            {feedback === 'correct' ? (
                              <><CheckCircle className="w-6 h-6" /> <span className="text-xl font-bold">¡Sabiduría absoluta! has descifrado el crecimiento.</span></>
                            ) : (
                              <><XCircle className="w-6 h-6" /> <span className="text-xl font-bold">La magia ha fallado. ¡Descifra el patrón y vuelve a intentar!</span></>
                            )}
                          </motion.div>
                        )}
                      </AnimatePresence>
              ...
              >
                ...
                <div className="p-8">
                  <div className="flex items-center gap-3 text-accent-yellow mb-6">
                    ...
                    <h3 className="text-2xl font-black uppercase tracking-tighter">Guía Geométrica</h3>
                  </div>
