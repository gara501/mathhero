      ...
      >
        ...
        <form onSubmit={handleStart} className="space-y-6">
          <div className="space-y-2">
            <label className="text-sm font-semibold text-text-secondary flex items-center gap-2 px-1">
            ...
            <input
              ...
              className="w-full px-4 py-3 bg-dark-card border border-border-color rounded-xl text-text-primary focus:outline-none focus:border-accent-yellow transition-smooth shadow-inner"
            />
          </div>
          ...
          <div className="space-y-2">
            ...
            <div className="flex gap-2">
              ...
              <button
                ...
                className="p-3 bg-dark-card border border-border-color rounded-xl hover:bg-dark-card-hover transition-smooth text-text-secondary"
          ...
          <button
            ...
            className="w-full py-4 bg-gradient-to-r from-accent-yellow to-gradient-to text-dark-bg font-bold rounded-2xl shadow-glow hover:scale-[1.02] active:scale-[0.98] transition-all flex items-center justify-center gap-2 disabled:opacity-50 disabled:grayscale"
          >
