          ...
          {showIntro ? (
              ...
              <div className="flex flex-col md:flex-row items-center gap-8 p-8">
                ...
                <div className="flex-1 text-center md:text-left">
                  ...
                  <h2 className="text-2xl md:text-3xl font-bold text-text-primary dark:text-white mb-6 leading-tight">
                    "¡Bienvenido al Valle de las Divisiones! Aquí aprenderás a repartir el poder matemático de forma equitativa. ¡Adelante!"
                  </h2>
            ...
            >
              <div className="text-center mb-8">
                <h1 className="text-4xl font-black gradient-text">Valle Divisiones</h1>
