            ...
            >
              <div className="flex justify-between items-end mb-8">
                <div>
                  ...
                  <p className="text-tertiary dark:text-white/60">Encuentra el número que falta en la serie</p>
                </div>
              ...
              >
                {problem && (
                  <div className="w-full text-center p-4">
                    <div className="mb-12">
                      <p className="text-xl text-tertiary dark:text-white/60 mb-8 italic">¿Qué número falta en este camino?</p>
                      ...
                      {!problemClosed ? (
                        ...
                        <div className="space-y-6">
                          <div className="card bg-accent-yellow/5 border-accent-yellow/20">
                            ...
                            <p className="text-2xl font-bold text-primary dark:text-white">Diferencia común (d) = {problem.commonDifference}</p>
                          </div>
