          ...
          {showIntro ? (
              ...
              <div className="flex flex-col md:flex-row items-center gap-8 p-8">
                ...
                <div className="flex-1 text-center md:text-left">
                  <div className="flex items-center gap-2 mb-4 justify-center md:justify-start text-accent-yellow">
                    ...
                    <span className="text-xs font-black uppercase tracking-widest">Maestro de Aritmética</span>
                  </div>
                  
                  <h2 className="text-2xl md:text-3xl font-bold text-text-primary dark:text-white mb-6 leading-tight">
                    "Las series aritméticas crecen paso a paso, con un ritmo constante. ¿Podrás encontrar la diferencia oculta?"
                  </h2>
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
                    ...
                    >
                      <span className="relative z-10">¡Empezar Reto!</span>
                ...
                {showExplanation && (
                  ...
                  >
                    <div className="p-8 border-t-2 border-accent-yellow/10">
                      <h4 className="text-xl font-bold text-accent-yellow mb-4">¿Qué es una Serie Aritmética?</h4>
                      <p className="text-text-secondary dark:text-white/80 leading-relaxed">
                        Es una secuencia donde cada número se obtiene sumando siempre la misma cantidad al anterior. 
                        Por ejemplo, en 5, 8, 11, 14... la diferencia es +3. 
                        Tu misión es encontrar esa diferencia y completar el número que falta.
                      </p>
                    </div>
                  </motion.div>
                )}
            ...
            >
              <div className="flex justify-between items-end mb-8">
                <div>
                  <h1 className="text-3xl font-bold gradient-text">Series Aritméticas</h1>
                  <p className="text-text-tertiary dark:text-white/60">Encuentra el número que falta en la serie</p>
                </div>
              ...
              >
                {problem && (
                  <div className="w-full text-center p-4">
                    <div className="mb-12">
                      <p className="text-xl text-text-tertiary dark:text-white/60 mb-8 italic">¿Qué número falta en este camino?</p>
                    ...
                    <div className="max-w-md mx-auto space-y-6">
                      {!problemClosed ? (
                        ...
                        <div className="space-y-6">
                          <div className="card bg-accent-yellow/5 border-accent-yellow/20">
                            <p className="text-sm text-accent-yellow uppercase font-black tracking-widest mb-1">Secreto del Camino</p>
                            <p className="text-2xl font-bold text-text-primary dark:text-white">Diferencia común (d) = {problem.commonDifference}</p>
                          </div>
                      ...
                      <AnimatePresence>
                        {feedback && (
                          ...
                          >
                            {feedback === 'correct' ? (
                              <><CheckCircle className="w-6 h-6" /> <span className="text-xl font-bold">¡Sabiduría absoluta! has encontrado el paso.</span></>
                            ) : (
                              <><XCircle className="w-6 h-6" /> <span className="text-xl font-bold">La magia ha fallado. ¡Observa la serie y vuelve a intentar!</span></>
                            )}
                          </motion.div>
                        )}
                      </AnimatePresence>
              ...
              >
                ...
                <div className="p-8">
                  <div className="flex items-center gap-3 text-accent-yellow mb-6">
                    ...
                    <h3 className="text-2xl font-black uppercase tracking-tighter">Guía Aritmética</h3>
                  </div>

                  <div className="space-y-6 max-h-[60vh] overflow-y-auto pr-4 custom-scrollbar">
                    <div className="p-6 bg-dark-bg/50 rounded-2xl border-2 border-white/5">
                      <h4 className="text-lg font-bold text-accent-yellow mb-2">Fórmula Maestra</h4>
                      <div className="bg-dark-bg p-4 rounded-xl border border-white/10 font-mono text-center mb-4">
                        <span className="text-accent-yellow">aₙ = a₁ + (n-1)d</span>
                      </div>
                      <p className="text-text-secondary dark:text-white/80 leading-relaxed">
                        Donde <strong>a₁</strong> es el primer término y <strong>d</strong> es el salto constante entre números.
                      </p>
                    </div>
                    ...
                    <div className="p-6 bg-accent-yellow/10 rounded-2xl border-2 border-accent-yellow/20">
                      ...
                      <p className="text-sm text-text-secondary dark:text-white/70 italic">
                        "¡Resta dos números seguidos de la serie! Esa diferencia es la llave que abre el siguiente número."
                      </p>
                    </div>
                  </div>
                </div>
